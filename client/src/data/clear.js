import fs from "fs";
// 1. Bring in your messy JavaScript array list
...
// 2. This completely ignores the formatting rules and converts it to strict JSON natively
const cleanJSON = JSON.stringify(productList, null, 2);

// 3. Write it into a brand new clean file
fs.writeFileSync("products.json", cleanJSON);

console.log(
  "✅ Success! Your perfect products.json file has been created with zero comma errors.",
);
